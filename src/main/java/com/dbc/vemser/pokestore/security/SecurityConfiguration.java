        ...
        http.headers()
                ...
                .authorizeHttpRequests((authz) ->
                        authz.antMatchers("/login", "/login/cadastro", "/login/esqueci-senha").permitAll()
                                ...
                                .antMatchers("/pedido/**").hasAnyRole("CLIENTE","VENDEDOR","ADMIN")
                                .antMatchers("/pagamento/**").hasAnyRole("CLIENTE","ADMIN")
                                .antMatchers(HttpMethod.GET, "/pagamento/**").hasRole("VENDEDOR")
                                .antMatchers("/avaliacao-produto").hasAnyRole("CLIENTE","VENDEDOR","ADMIN")
